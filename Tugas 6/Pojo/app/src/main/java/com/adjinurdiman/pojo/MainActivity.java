    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_with_data_activity:
                ...
                moveWithDataIntent.putExtra(MoveWithDataActivity.EXTRA_NAME, "Adji Nurdiman");
            ...
            case R.id.btn_move_activity_object:
                ...
                mPerson.setName("Adji Nurdiman");
                mPerson.setAge(17);
                mPerson.setEmail("adjinurdiman@gmail.com");
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "08888274192";
